...
const ProductAdminPage:FC<Props> = ({ product }) => {
    ...
    const onChangeSizes = ( size: string ) => {
        ...
        // si condicion = eliminar
        if( currentSizes.includes( size ) ){
            return setValue('sizes', currentSizes.filter( s => s !== size ), { shouldValidate: true } );
        }
        // si no condicion añadir
    ...
    const onSubmit = async( form: FormData ) => {
        ...
        if( form.images.length < 2 ) return alert('Es necesario 2 imágenes');
        setIsSaving(true);
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={ 6 }>
                        ...
                        <TextField
                            ...
                            { ...register('inStock', {
                                required: 'Este campo es requerido',
                                min: { value:0, message:'El valo mínimo en cero'}
                            })}
                    ...
                    <Grid item xs={12} sm={ 6 }>
                        ...
                        <TextField
                            ...
                            onKeyUp={ ({code}) => (code === 'Space' || code === 'Enter') ? onNewTag() : undefined }
                        />
...
export const getServerSideProps: GetServerSideProps = async ({ query }) => {
    ...
    //  admin/products.tsx - href='/admin/products/new'
